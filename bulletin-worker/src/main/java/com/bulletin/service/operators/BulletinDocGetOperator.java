package com.bulletin.service.operators;

import com.bulletin.service.impl.V6ESClient;
...
@Slf4j
@Service
public class BulletinDocGetOperator extends WorkerDocGetOperator {

    @Value("${BULLETIN_DOC_GET_HANDLER_KEY:BULLETIN_DOC_GET}")
    private String HANDLER_KEY;
    @Value("${BULLETIN_DOC_GET_OPERATOR_ACTIVE:true}")
    private boolean OPERATOR_ACTIVE;

    @Value("${BULLETIN_DOC_GET_DATA_TYPE:doc}")
    private String DATA_TYPE;

    @Value("${BULLETIN_DOC_GET_OPERATOR_TIMEOUT:2000}")
    private int TIMEOUT;

    @Value("${BULLETIN_DOC_GET_CACHE_TYPE:REDIS}")
    protected String CACHE_TYPE;

    @Value("${BULLETIN_DOC_GET_ES_ADDRESS:localhost:9200}")
    protected String ES_ADDRESS;
    @Value("${BULLETIN_DOC_GET_ES_USERNAME:}")
    protected String ES_USERNAME;
    @Value("${BULLETIN_DOC_GET_ES_PASSWORD:}")
    protected String ES_PASSWORD;
    @Value("${BULLETIN_DOC_GET_ES_INDEX:}")
    protected String ES_INDEX;

    @Value("${BULLETIN_DOC_GET_DECAY_TYPE:HYPERBOLIC}")
    private String DECAY_TYPE;
    @Value("${BULLETIN_DOC_GET_TIME_DECAY:0.4}")
