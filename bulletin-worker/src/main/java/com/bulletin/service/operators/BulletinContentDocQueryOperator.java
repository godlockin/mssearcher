...
@Slf4j
@Service
public class BulletinContentDocQueryOperator extends WorkerDocQueryOperator {

    @Value("${BULLETIN_CONTENT_DOC_QUERY_HANDLER_KEY:BULLETIN_CONTENT_DOC_QUERY}")
    private String HANDLER_KEY;
    @Value("${BULLETIN_CONTENT_DOC_QUERY_OPERATOR_ACTIVE:true}")
    ...
    @Value("${BULLETIN_CONTENT_DOC_QUERY_OPERATOR_TIMEOUT:2000}")
    private int TIMEOUT;
    ...
    @Value("${BULLETIN_CONTENT_DOC_QUERY_TIME_DECAY:0.8}")
