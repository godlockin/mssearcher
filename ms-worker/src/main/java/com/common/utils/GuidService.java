...
public class GuidService {
    ...
    public static String getXXHash(String base) { return String.format("%016X", XXHash.hash64(base.getBytes())).toLowerCase(); }

    public static String getMurmurHash(String base) { return String.format("%016X", MurmurHash.hash64(base)).toLowerCase(); }
}
